...
import com.sap.rc.main.config.EmbeddedDatabaseConfig;
import com.sap.rc.main.config.LiquibaseConfig;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = { EmbeddedDatabaseConfig.class, LiquibaseConfig.class })
public class AdvertisementRepositoryTest {
    ...
    public void fromEntityToDto() {
        ...
        assertThat(dto.metadata.version, is(1));
